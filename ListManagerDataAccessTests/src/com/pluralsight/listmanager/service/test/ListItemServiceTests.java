...
public class ListItemServiceTests {
	...
	@Test
	public void whenUpdatingAListItem_givenValidInput_itShouldReturnTheUpdatedListItem() throws SQLException {

		// Arrange
		final ListItemService listItemService = new ListItemServiceImpl();
		final ListItem addedListItem = listItemService.addListItem(1L, "Testing 123");
		final long initialLastItemCount = DataSourceSetupUtil.getListItemsCount();
		...
		Assert.assertEquals(initialLastItemCount, DataSourceSetupUtil.getListItemsCount());
	}
	...
	public void whenDeletingAListItem_givenValidInput_itShouldDelete() throws SQLException {
		...
		// Assert
		Assert.assertEquals(initialLastItemCount - 1, DataSourceSetupUtil.getListItemsCount());
	}
}