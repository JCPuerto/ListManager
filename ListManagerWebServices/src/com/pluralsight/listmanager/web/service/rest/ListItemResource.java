...
import com.pluralsight.listmanager.web.service.rest.viewmodel.ValueViewModel;
...
public class ListItemResource {
	...
	public List<ListItem> getAll(@PathParam("userId") Long userId){
	...
	@Produces(MediaType.APPLICATION_JSON)
	public ListItem add(@PathParam("userId") Long userId, ValueViewModel valueViewModel){
	...
	@Consumes(MediaType.APPLICATION_JSON)
	@Produces(MediaType.APPLICATION_JSON)
	public ListItem update(@PathParam("userId") Long userId, @PathParam("listItemId") Long listItemId, ValueViewModel valueViewModel){
		return listItemService.updateListItem(userId, listItemId, valueViewModel.getValue());
	}
	
	@DELETE
	@Path("/{listItemId}")
	public void delete(@PathParam("userId") Long userId, @PathParam("listItemId") Long listItemId){
